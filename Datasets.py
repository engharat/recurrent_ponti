...
class KW51(Dataset):
    ...
    def __init__(self, base_folder="~/Downloads/traindata_csv/Train_folder_traindata/",substract=False,max_seq_len=32768,decimate_factor=100,scaler=None,data_aug=False):
